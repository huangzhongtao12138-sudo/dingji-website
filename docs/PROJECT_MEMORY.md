...
- 南京鼎基装饰工程有限公司：聚焦新店开发，承接设计深化、装饰施工、机电消防与新店工程落地。
- 南京润发装饰有限公司：聚焦既有门店的改造、维修、维护与升级支持。
- 金昇制造：聚焦成品制造、粉末喷涂与按需定制，以工厂端工艺和品质控制支持项目落地，并通过减少中间环节与返工优化综合成本。
- 官网对三家公司关系的稳定表述是“一个项目窗口、三支专业团队协同”。不得写成未经确认的集团股权关系，也不得把成本优势写成无条件最低价承诺。
